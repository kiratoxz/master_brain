...
import 'package:master_brain/classes/swap_action.dart';
import 'package:master_brain/enums/event.dart';
import 'package:master_brain/constants/game_constants.dart';
import 'package:master_brain/enums/swap_item_name.dart';
import 'package:master_brain/classes/event_generator.dart';
...
import 'package:master_brain/ui/widgets/score_dialog.dart';
...
class Driver {
  ...
  void restart() async {
    ...
    (_stateKeysMap[WidgetName.alarmClock]?.currentState as AlarmClockState)
        .startClock();
    //  if the user clicked on the restart button before the victory or game over music finished stop it
